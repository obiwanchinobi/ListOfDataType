...
public class Book extends com.intersys.classes.Persistent {
    ...
    */
    public Book (com.intersys.cache.CacheObject ref) throws com.intersys.objects.CacheException {
        super (ref);
    }
    public Book (com.intersys.objects.Database db, String initstr) throws com.intersys.objects.CacheException {
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException in case of error.
              ...
              @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
     */
    public Book (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    ...
    */
    ...
    /**
      ...
      @see <a href = "http://manzi.local:57121/csp/documatic/DocBook.UI.Page.cls?KEY=GOBJ_concurrency"> Object Concurrency Options.</A>
    ...
    /**
      ...
      @see java.lang.ClassCastException
           @see #_open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #Book(com.intersys.objects.Database)
     */
   ...
   */
    ...
    public static void checkAllMethods(com.intersys.objects.Database db ) throws com.intersys.objects.CacheException {
        checkAllMethods(db, CACHE_CLASS_NAME, Book.class);
    }
    public static void checkTagsValid (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    }
    /**
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     <p>Runs method CreateBook in Cache.</p>
     @param db represented as com.intersys.objects.Database
    ...
    */
    public static void CreateBook (com.intersys.objects.Database db, java.util.List tags) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(tags);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"CreateBook",args,com.intersys.objects.Database.RET_NONE);
        return;
    }
    /**
    ...
    */
    public com.intersys.objects.Oid TagsGetObject () throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[0];
        com.intersys.cache.Dataholder res=mInternal.runInstanceMethod("TagsGetObject",args,com.intersys.objects.Database.RET_PRIM);
        return res.getOid();
    }
    /**
     <p>Runs method TagsGetObject in Cache.</p>
    ...
    */
    public java.lang.String TagsGetObjectId () throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[0];
        com.intersys.cache.Dataholder res=mInternal.runInstanceMethod("TagsGetObjectId",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     <p>Runs method TagsGetObjectId in Cache.</p>
    ...
    */
    ...
    /**
     <p>Runs method TagsIsValid in Cache.</p>
     @param db represented as com.intersys.objects.Database
    ...
    */
    public static void TagsIsValid (com.intersys.objects.Database db, java.lang.String value) throws com.intersys.objects.CacheException {
        ...
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"TagsIsValid",args,com.intersys.objects.Database.RET_PRIM);
        db.parseStatus(res);
        return;
    }
    /**
    ...
    */
    public void TagsSetObject (com.intersys.objects.Oid newvalue) throws com.intersys.objects.CacheException {
        ...
        com.intersys.cache.Dataholder res=mInternal.runInstanceMethod("TagsSetObject",args,com.intersys.objects.Database.RET_PRIM);
    ...
    */
    public void TagsSetObjectId (java.lang.String newid) throws com.intersys.objects.CacheException {
        ...
        com.intersys.cache.Dataholder res=mInternal.runInstanceMethod("TagsSetObjectId",args,com.intersys.objects.Database.RET_PRIM);
        getDatabase().parseStatus(res);
        return;
    }
    /**
    ...
    */
    public static void Test (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[0];
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"Test",args,com.intersys.objects.Database.RET_NONE);
        return;
    }
    /**
    ...
    */
    ...
    public static Object addToBatchInsert (Object batch, java.sql.Connection con) throws java.sql.SQLException {
        ...
        com.intersys.jdbc.SysListProxy.setUndefined(qbatch.list); // for Tags
